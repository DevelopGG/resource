--print("-- Herbalist")
---------------------------------------------
-- Баланс характеристик профессии Знахарка --
---------------------------------------------
	--Макс. кол-во ХП от кона, кона, уровня.
	Mxhp_con_rad1[JOB_TYPE_QIYUANSHI], Mxhp_con_rad2[JOB_TYPE_QIYUANSHI], Mxhp_lv_rad[JOB_TYPE_QIYUANSHI]	= 5, 5, 100				
	...
	Aspd_agi_rad[JOB_TYPE_QIYUANSHI]	= 0.1   						 			
