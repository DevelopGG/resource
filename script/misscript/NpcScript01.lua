...
function guilds()
	...
	TriggerAction( 1, TakeMoney, 3000000,3000000 )
...
function Buster()
	...
	Text( 1, "Уйти ", CloseTalk )
	Talk( 2, "Выбирай дорогой какой лвл тебе нужен")
	InitTrigger()
	...
	TriggerFailure( 1, JumpPage, 2 )
	Text( 2, "1 Маг.Бустеры 5 лвл  - 500 плам.баксов", MultiTrigger, GetMultiTrigger(), 1)
	Text( 2, "В начало ",JumpPage, 1 )
	Text( 3,  "Выбирай дорогой какой лвл тебе нужен ")
	
	Talk( 2, "Выбирай дорогой какой лвл тебе нужен")
	InitTrigger()
	TriggerCondition( 1, HasItem,4281,40 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 4281,40 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 4276, 1, 4 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 3 )
	Text( 3, "2 Физ.Бустеры 1 лвл - 40 Хвостиков с моря", MultiTrigger, GetMultiTrigger(), 1)
	InitTrigger()
	TriggerCondition( 1, HasItem,4281,80 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 4281,80 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 4277, 1, 4 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 3 )
	Text( 3, "2 Физ.Бустеры 2 лвл - 80 Хвостиков с моря", MultiTrigger, GetMultiTrigger(), 1)
	InitTrigger()
	TriggerCondition( 1, HasItem,4281,120 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 4281,120 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 4278, 1, 4 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 3 )
	Text( 3, "2 Физ.Бустеры 3 лвл - 120 Хвостиков с моря", MultiTrigger, GetMultiTrigger(), 1)
	InitTrigger()
	TriggerCondition( 1, HasItem,4281,160 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 4281,160 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 4279, 1, 4 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 3 )
	Text( 3, "2 Физ.Бустеры 4 лвл - 160 Хвостиков с моря", MultiTrigger, GetMultiTrigger(), 1)
	InitTrigger()
	TriggerCondition( 1, HasItem,4281,200 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 4281,200 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 4280, 1, 4 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 3 )
	Text( 3, "2 Физ.Бустеры 5 лвл - 200 Хвостиков с моря", MultiTrigger, GetMultiTrigger(), 1)
	Text( 3, "В начало ",JumpPage, 1)
end
...
function for_newbie()
	...
	Text( 1, "Сет Смерти ", JumpPage, 2)
	--Text( 1, "Пояс Смерти ", JumpPage, 3)
	--Text( 1, "Наручи Смерти ", JumpPage, 4)
	--Text( 1, "Браслет Смерти ", JumpPage, 5)
	Text( 1, "Уйти. ", CloseTalk )
	Talk( 2, "Чтобы получить Сет Смерти, принеси мне:_1.Ясеневое бревно - 100;_2.Темный камень желаний - 100;_3.Необогащённая железная руда - 100;_4.Карта Ммини-босса Москвы- 1;_5.Золото - 650.000. " )
	InitTrigger()
	...
	TriggerCondition( 1, HasItem,8125,1 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasMoney, 650000 )
	TriggerAction( 1, TakeMoney, 650000 )
	...
	TriggerAction( 1, TakeItem, 8125,1 ) -- Это функция "изьятия" предмета и в каком количестве
	...
	Talk( 3, "Чтобы получить Пояс Смерти, принеси мне:_1.Ясеневое бревно - 50;_2.Темный камень желаний - 50;_3.Необогащённая железная руда - 50;_4.Карта Ммини-босса Москвы- 1;_5.Золото - 300.000. " )
	InitTrigger()
	TriggerCondition( 1, HasItem,3989,50 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,3905,50 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,1667,50 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,8125,1 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasMoney, 300000 )
	TriggerAction( 1, TakeItem, 3989,50 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 3905,50 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 1667,50 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 8125,1 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeMoney, 300000 )
	TriggerAction( 1, GiveItem, 7778,1,4 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 3 )
	Text( 3, "Обменять Пояс Смерти. ", MultiTrigger, GetMultiTrigger(), 1)
	Text( 3, "Уйти. ", CloseTalk )
	
	Talk( 4, "Чтобы получить Наручи Смерти, принеси мне:_1.Ясеневое бревно - 40;_2.Темный камень желаний - 40;_3.Необогащённая железная руда - 40;_4.Карта Ммини-босса Москвы- 1;_5.Золото - 200.000. " )
	InitTrigger()
	TriggerCondition( 1, HasItem,3989,40 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,3905,40 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,1667,40 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,8125,1 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasMoney, 200000 )
	TriggerAction( 1, TakeItem, 3989,40 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 3905,40 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 1667,40 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 8125,1 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeMoney, 200000 )
	TriggerAction( 1, GiveItem, 7780,1,4 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 3 )
	Text( 4, "Обменять Наручи Смерти. ", MultiTrigger, GetMultiTrigger(), 1)
	Text( 4, "Уйти. ", CloseTalk )
	
	Talk( 5, "Чтобы получить Браслет Смерти, принеси мне:_1.Ясеневое бревно - 30;_2.Темный камень желаний - 30;_3.Необогащённая железная руда - 30;_4.Карта Ммини-босса Москвы- 1;_5.Золото - 100.000. " )
	InitTrigger()
	TriggerCondition( 1, HasItem,3989,30 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,3905,30 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,1667,30 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,8125,1 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasMoney, 100000 )
	TriggerAction( 1, TakeItem, 3989,30 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 3905,30 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 1667,30 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 8125,1 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeMoney, 100000 )
	TriggerAction( 1, GiveItem, 7779,1,4 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 3 )
	Text( 5, "Обменять Наручи Смерти. ", MultiTrigger, GetMultiTrigger(), 1)
	Text( 5, "Уйти. ", CloseTalk )
...
function BT_NewUser001()
	...
	--ext( 1, "Узнать расположение монстров", JumpPage, 30 )
...
function cm_1()
	...
	Text( 1, "Бижутерия Беса ", JumpPage, 4)
	Text( 1, "Уйти ", CloseTalk )
	...
	Talk( 5, "Чтобы получить Ожерелье Беса, принеси мне:_1. Камень Лоха - 130шт;_2. Камень Пердуна - 130шт;_3. Пламенный бакс - 3000 шт. ")
	InitTrigger()
	TriggerCondition( 1, HasItem,508,130 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,506,130 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,3458,3000 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 508,130 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 506,130 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 3458,3000 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 5026,1,4 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 10 )
	Text( 5, "Обменять ожерелье ", MultiTrigger, GetMultiTrigger(), 1)InitTrigger()
	Text( 5, "Уйти", CloseTalk)
	
	Talk( 6, "Чтобы получить Кольцо Беса, принеси мне:_1. Камень Лоха - 80шт;_2. Камень Пердуна - 80шт_3. Пламенный бакс - 2000 шт. ")
	InitTrigger()
	...
	TriggerAction( 1, TakeItem, 3458,2000 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 5025,1,4 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 10 )
...
function cm_2()
	...
	Text( 1, "Камень снаряжения Беса ", JumpPage, 2)
	Text( 1, "Камень оружия Беса ", JumpPage, 3)
	Text( 1, "Обмен мечей Воителя ", JumpPage, 4)
	Text( 1, "Уйти ", CloseTalk )
	
	Talk( 2, "Чтобы получить Камень Снаряжения Беса, принеси мне:_1. Часть Кремля 1 - 30шт;_2. Часть Кремля 2 - 30шт;_3. Часть Кремля 3 - 30шт;_4. Часть Кремля 4 - 30шт;_5. Камень Лоха - 10шт_6. Пламенный бакс - 10000шт. ")
	InitTrigger()
	...
	Talk( 3, "Чтобы получить Камень Оружия Беса, принеси мне:_1. Мощь Олега - 50шт;_2. Мощь Витька - 50шт;_3. Мощь Герыча - 50шт;_4. Мощь Мента - 50шт;_5. Камень Пердуна - 30шт;_6. Пламенный бакс - 8000шт; ")
	InitTrigger()
...
function hitdodje()
	Talk( 1, "Привет, бро! У меня ты можешь обменять свои кели на Лок и Бинг: ")
	Text( 1, "Взять 1 Лок", JumpPage, 2)
	Text( 1, "Взять 4 Лока ", JumpPage, 3)
	Text( 1, "Взять 16 Локов", JumpPage, 4)
	Text( 1, "Взять 1 Бинг", JumpPage, 5)
	Text( 1, "Взять 4 Бинга ", JumpPage, 6)
	Text( 1, "Взять 16 Бингов", JumpPage, 7)
	Text( 1, "Уйти ", CloseTalk )
	Talk( 2, "Чтобы получить лок, принеси мне:_10шт келей. ") -- Локи
	InitTrigger()
	TriggerCondition( 1, HasItem, 3457,10 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 3457,10 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 15772,1,101 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 10 )
	Text( 2, "1шт Лок ", MultiTrigger, GetMultiTrigger(), 1)
	Talk( 3, "Чтобы получить 4 лока, принеси мне:_40шт келей. ")
	InitTrigger()
	...
	TriggerFailure( 1, JumpPage, 10 )
	Text( 3, "4шт Лока ", MultiTrigger, GetMultiTrigger(), 1)
	Talk( 4, "Чтобы получить 16 локов, принеси мне:_160шт келей. ")
	InitTrigger()
	...
	TriggerFailure( 1, JumpPage, 10 )
	Text( 4, "16шт Локов ", MultiTrigger, GetMultiTrigger(), 1)
	Talk( 5, "Чтобы получить бинг, принеси мне:_10шт келей. ") --Бинги
	InitTrigger()
	TriggerCondition( 1, HasItem, 3457,10 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 3457,10 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 15773,1,101 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 10 )
	Text( 5, "1шт Бинг ", MultiTrigger, GetMultiTrigger(), 1)
	Talk( 6, "Чтобы получить 4 бинга, принеси мне:_40шт келей. ")
	InitTrigger()
	TriggerCondition( 1, HasItem, 3457,40 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 3457,40 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 15773,4,101 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 10 )
	Text( 6, "4шт Бинга ", MultiTrigger, GetMultiTrigger(), 1)
	Talk( 7, "Чтобы получить 16 бингов, принеси мне:_160шт келей. ")
	InitTrigger()
	TriggerCondition( 1, HasItem, 3457,160 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 3457,160 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, GiveItem, 15773,16,101 ) -- Это функция выдачи предмета (ID, кол-во)
	TriggerFailure( 1, JumpPage, 10 )
	Text( 7, "16шт Бингов ", MultiTrigger, GetMultiTrigger(), 1)
	Talk( 10, "Вам не хватает лута для обмена! ")
	Text( 10, "Уйти. ", CloseTalk)
end