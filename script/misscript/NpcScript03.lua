...
function angela()
	...
	Text( 1, "Попасть на небеса ", GoTo, 1750, 906,  "jialebi" )
	Text( 1, "Камень второго перерождения ", JumpPage, 2)
	Text( 1, "Фрукт памяти СССР ", JumpPage, 3)
	Text( 1, "Уйти. ", CloseTalk)
	
	Talk( 2, "Чтобы получить камень второго перерождения, принеси мне:_1. Сигара - 50 шт;_2. Каменное яйцо - 10 шт;_3. Бандитская доска - 20шт. ")
	InitTrigger()
	TriggerCondition( 1, HasItem,1736,50 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,1735,10 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasItem,1748,20 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 1736,50 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 1735,10 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerAction( 1, TakeItem, 1748,20 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerFailure( 1, JumpPage, 13 )
	TriggerAction( 1, GiveItem, 6949,1,4 ) -- Это функция выдачи предмета (ID, кол-во)
	Text( 2, "Обменять камень ", MultiTrigger, GetMultiTrigger(), 1)
	Text( 2, "Уйти. ", CloseTalk)
...
function skelet_isl()
	...
	Text( 1, "Сет Гончей Ада(175ур.)", JumpPage, 2)
	...
	Text( 2, "Шапка 175 ", JumpPage, 3)
	Text( 2, "Торс 175 ", JumpPage, 4)
	Text( 2, "Перчатки 175 ", JumpPage, 5)
	Text( 2, "Ботинки 175 ", JumpPage, 6)
	Text( 2, "Запечатанное оружие 175 ", JumpPage, 7)
	Text( 2, "Уйти. ", CloseTalk)
	...
	--Оружие 175
	Talk( 7, "Чтобы получить оружие Гончей Ада, принеси мне:_1. Грязный кристалл - 3шт;_2. Золото - 100 миллионов;_3. Репутация - 500. ")
	InitTrigger()
	TriggerCondition( 1, HasItem,1751,3 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerCondition( 1, HasMoney, 100000000,100000000 )
	TriggerCondition( 1, HasCredit, 500 )
	TriggerAction( 1, TakeItem, 1751,3 ) -- Это функция "изьятия" предмета и в каком количестве
	...
	Talk( 10, "Чтобы получить свиток опыта х4, принеси мне:_1. 400 репутации; 2. Золото - 40.000.000. ")
	InitTrigger()
	TriggerCondition( 1, HasCredit, 400 )
	TriggerCondition( 1, HasMoney, 40000000,40000000 )
	TriggerAction( 1, DelRoleCredit, 400 )
...
function gems_14()
	...
	Talk(1, "Привет. Хочешь получить самоцвет +14 к характеристикам? Принеси мне:_1.Ссохшийся деб-камень - 10шт. ")
	InitTrigger()
	TriggerCondition( 1, HasItem,2471,10 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 2471,10 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerFailure( 1, JumpPage, 3 )
	TriggerAction( 1, GiveItem, 8021,1,101 ) -- Это функция выдачи предмета (ID, кол-во)
	Text( 1, "Самоцвет Силы ", MultiTrigger, GetMultiTrigger(), 1)
	InitTrigger()
	TriggerCondition( 1, HasItem,2471,10 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 2471,10 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerFailure( 1, JumpPage, 3 )
	TriggerAction( 1, GiveItem, 8022,1,101 ) -- Это функция выдачи предмета (ID, кол-во)
	Text( 1, "Самоцвет Духа ", MultiTrigger, GetMultiTrigger(), 1)
	InitTrigger()
	TriggerCondition( 1, HasItem,2471,10 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 2471,10 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerFailure( 1, JumpPage, 3 )
	TriggerAction( 1, GiveItem, 8023,1,101 ) -- Это функция выдачи предмета (ID, кол-во)
	Text( 1, "Самоцвет Точности ", MultiTrigger, GetMultiTrigger(), 1)
	InitTrigger()
	TriggerCondition( 1, HasItem,2471,10 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 2471,10 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerFailure( 1, JumpPage, 3 )
	TriggerAction( 1, GiveItem, 8024,1,101 ) -- Это функция выдачи предмета (ID, кол-во)
	Text( 1, "Самоцвет Телосложения ", MultiTrigger, GetMultiTrigger(), 1)
	InitTrigger()
	TriggerCondition( 1, HasItem,2471,10 ) --Это функция проверки какой итем и в каком количестве должен быть в рюкзаке
	TriggerAction( 1, TakeItem, 2471,10 ) -- Это функция "изьятия" предмета и в каком количестве
	TriggerFailure( 1, JumpPage, 3 )
	TriggerAction( 1, GiveItem, 8025,1,101 ) -- Это функция выдачи предмета (ID, кол-во)
	Text( 1, "Самоцвет Ловкости ", MultiTrigger, GetMultiTrigger(), 1)
	Text(1, "Уйти. ", CloseTalk)
	
	Talk(3, "Чтобы вы понимали, на самоцвет +14 СИЛЫ нужно иметь 2 самоцветы +7 СИЛЫ и 10 ссохшихся деб-камней. Удачи в добычи!) ")
	Text(3, "Уйти. ",CloseTalk)
