...
dofile(GetResPath("script/addon/GuildBank/GuildBank.lua"))
...
dofile(GetResPath("script/addon/Coliseum.lua"))
dofile(GetResPath("script/addon/SummonNPC/SummonNPC.lua"))
--dofile(GetResPath("script/addon/TempBagEquip/TempBagEquip.lua"))
print( "----------------END-----------------" )