--print("-- Explorer")
---------------------------------------------------
-- Баланс характеристик профессии Мореплаватель  --
---------------------------------------------------
	--Макс. кол-во ХП от кона, кона, уровня.
	Mxhp_con_rad1[JOB_TYPE_MAOXIANZHE], Mxhp_con_rad2[JOB_TYPE_MAOXIANZHE], Mxhp_lv_rad[JOB_TYPE_MAOXIANZHE]	= 5, 5, 100				
	...
	Aspd_agi_rad[JOB_TYPE_MAOXIANZHE]	= 0.1   						 				
