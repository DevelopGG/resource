--print("-- Hunter")
--------------------------------------------
-- Баланс характеристик профессии Охотник --
--------------------------------------------
	--Макс. кол-во ХП от кона, кона, уровня.
	Mxhp_con_rad1[JOB_TYPE_LIEREN], Mxhp_con_rad2[JOB_TYPE_LIEREN], Mxhp_lv_rad[JOB_TYPE_LIEREN]	= 3, 3, 100 				
	...
	Def_con_rad1[JOB_TYPE_LIEREN], Def_con_rad2[JOB_TYPE_LIEREN]	= 0.5, 0.5 					
	...
	Aspd_agi_rad[JOB_TYPE_LIEREN]	= 0.5   						 				--
	Str_updata[JOB_TYPE_LIEREN]	= 0.5 
