...
function ItemUse_Map_JLBYPJ( role , Item )
	...
	if lv <250 or  lv >400 then
		SystemNotice ( role , "\210\238\235\252\234\238 \239\229\240\241\238\237\224\230\232 \236\229\230\228\243 250 \232 400 \243\240\238\226\237\255\236\232 \236\238\227\243\242 \232\241\239\238\235\252\231\238\226\224\242\252 \205\238\226\251\233 \207\229\240\227\224\236\229\237\242" )
...
function ItemUse_WeiXing( role , Item )
	...
	if lv_star > 40 then
		...
		--SystemNotice ( role , "Эффективно только для игроков уровня 55 и ниже" )
...
if elf_lvl < 200 or elf_lvl >= 250 and elf_lvl <= 99999999999 then
SystemNotice(role , "Этот фрукт нельзя использовать, если Ваша фея меньше 200 уровня,а так же если выше 500 уровня " )
UseItemFailed ( role )
return
end
if Item_type == 58 and Item_Traget_Type == 59 then
...
function ItemUse_mewsfruit (role, Item)
	...
	local	sc = math.random(1,100)
	if  sc <=20 then	
		GiveItem ( role , 0 , 7430 , 1 , 4 )
	elseif sc <=40 then		
		GiveItem ( role , 0 , 7431 , 1 , 4 )       
	elseif sc <=60 then
		GiveItem ( role , 0 ,7419 , 1 , 4 )  
	elseif sc <=80 then
		GiveItem ( role , 0 ,7433 , 1 , 4 )   
	elseif sc <=100 then
		GiveItem ( role , 0 ,7434 , 1 , 4 )                   
	end
end
...
local sta = GetItemAttr(Item_Traget,ITEMATTR_VAL_STA)
local elf_lvl = str + con + agi + dex + sta
if elf_lvl < 100 or elf_lvl >= 150 and elf_lvl <= 99999999999 then
PopupNotice(role , "Этот фрукт нельзя использовать, если Ваша фея меньше 100 уровня,а так же если выше 150 уровня " )
UseItemFailed ( role )
return
end
if Item_type == 58 and Item_Traget_Type == 59 then
...
local sta = GetItemAttr(Item_Traget,ITEMATTR_VAL_STA)
local elf_lvl = str + con + agi + dex + sta
if elf_lvl < 150 or elf_lvl >= 200 and elf_lvl <= 99999999999 then
...
-- Фрукт на Аги +2 (от 1000 до 1200)
...
SystemNotice(role , "Этот фрукт нельзя использовать, если Ваша фея меньше 1000 уровня,а так же если выше 1200 уровня " )
UseItemFailed ( role )
return
end
if Item_type == 58 and Item_Traget_Type == 59 then
...
-- Фрукт на кон +2 (от 1000 до 1200)
...
-- Фрукт на акк +2 ((от 1000 до 1200)
...
-- Фрукт на Аги +2 (от 1200 до 1400)
...
SystemNotice(role , "Этот фрукт нельзя использовать, если Ваша фея меньше 1200 уровня,а так же если выше 1400 уровня " )
UseItemFailed ( role )
return
end
if Item_type == 58 and Item_Traget_Type == 59 then
...
-- Фрукт на стр +2 (от 1200 до 1400)
...
-- Фрукт на кон +2 (от 1200 до 1400)
...
-- Фрукт на акк +2 ((от 1200 до 1400)
...
-- Фрукт на спр +2 (от 1200 до 1400)
...
function ItemUse_mewsfruitt (role, Item)
	...
	local itemname = ""
	if  sc <=20 then	
		GiveItem ( role , 0 , 7523 , 1 , 4 )                    ---------------ФЄЛ§Ц®КЧ   »сµГ»ъВК20%
	elseif sc <=40 then		
		GiveItem ( role , 0 , 7524 , 1 , 4 )                    ---------------ХжєЪБъЦ®Ч¦   »сµГ»ъВК20%
	elseif sc <=60 then
		GiveItem ( role , 0 ,7525 , 1 , 4 )                    ---------------ХжєЪБъЦ®Тн   »сµГ»ъВК20%
	elseif sc <=80 then
		GiveItem ( role , 0 ,7526 , 1 , 4 )                    ---------------ОЮЛ«±¦Пд   »сµГ»ъВК15%
	elseif sc <=100 then
		GiveItem ( role , 0 ,7527 , 1 , 4 )                    ---------------ХжєЪБъЦ®Зы   »сµГ»ъВК14%
	end
end
...
function ItemUse_MoreGold( role , Item )
    ...
    PopupNotice ( role ,"Количество золота с монстров увеличено в 2 раза! " )
	local effect = 812              -- ID эффекта из sceneffectinfo.txt
    PlayEffect (role, effect )      -- Заставляем проигрывать эффект при открытии сундука
end
...
function ItemUse_MoreGoldA( role , Item )
    ...
    PopupNotice ( role ,"Количество золота с монстров увеличено в 2.5 раза! " )
	local effect = 812              -- ID эффекта из sceneffectinfo.txt
    PlayEffect (role, effect )      -- Заставляем проигрывать эффект при открытии сундука
end
...
function ItemUse_MoreGoldB( role , Item )
    ...
    PopupNotice ( role ,"Количество золота с монстров увеличено в 3 раза! " )
	local effect = 812              -- ID эффекта из sceneffectinfo.txt
    PlayEffect (role, effect )      -- Заставляем проигрывать эффект при открытии сундука
end

--Золотая ягода 5ур (ID 7997)
function ItemUse_MoreGoldC( role , Item )
    ...
    PopupNotice ( role ,"Количество золота с монстров увеличено в 3.5 раза! " )
	local effect = 812              -- ID эффекта из sceneffectinfo.txt
    PlayEffect (role, effect )      -- Заставляем проигрывать эффект при открытии сундука
end

--Золотая ягода 6ур (ID 7998)
function ItemUse_MoreGoldD( role , Item )
    ...
    PopupNotice ( role ,"Количество золота с монстров увеличено в 4 раза! " )
	local effect = 812              -- ID эффекта из sceneffectinfo.txt
    PlayEffect (role, effect )      -- Заставляем проигрывать эффект при открытии сундука
end
...
function ItemUse_FizBust1( role , Item )
	...
	if (a > 0 and a < 25) then
		GiveItem ( role , 0 , 1524 , 1 , 4 ) --Берс
	elseif (a >= 25 and a <= 50) then
		GiveItem ( role , 0 , 1529 , 1 , 4 ) --Ускор бега
	elseif (a > 50 and a <= 75) then
		GiveItem ( role , 0 , 1534 , 1 , 4 ) --Додж
	elseif (a > 75 and a <= 100) then
		GiveItem ( role , 0 , 1539 , 1 , 4 ) --Хит
	elseif (a > 100 and a <= 125) then
		GiveItem ( role , 0 , 1524 , 3 , 4 ) --Берс
	elseif (a > 125 and a <= 150) then
		GiveItem ( role , 0 , 1529 , 3 , 4 ) --Ускор бега
	elseif (a > 150 and a <= 175) then
		GiveItem ( role , 0 , 1534 , 3 , 4 ) --Додж
	elseif (a > 175 and a <= 200) then
		GiveItem ( role , 0 , 1539 , 3 , 4 ) --Хит
	end
end
...
function ItemUse_FizBust2( role , Item )
	local a = math.random(1, 200)
	if (a > 0 and a < 25) then
		GiveItem ( role , 0 , 1525 , 1 , 4 ) --Берс
	elseif (a >= 25 and a <= 50) then
		GiveItem ( role , 0 , 1530 , 1 , 4 ) --Ускор бега
	elseif (a > 50 and a <= 75) then
		GiveItem ( role , 0 , 1535 , 1 , 4 ) --Додж
	elseif (a > 75 and a <= 100) then
		GiveItem ( role , 0 , 1540 , 1 , 4 ) --Хит
	elseif (a > 100 and a <= 125) then
...
function ItemUse_FizBust3( role , Item )
	local a = math.random(1, 200)
	if (a > 0 and a < 25) then
		GiveItem ( role , 0 , 1526 , 1 , 4 ) --Берс
	elseif (a >= 25 and a <= 50) then
		GiveItem ( role , 0 , 1531 , 1 , 4 ) --Ускор бега
	elseif (a > 50 and a <= 75) then
		GiveItem ( role , 0 , 1536 , 1 , 4 ) --Додж
	elseif (a > 75 and a <= 100) then
		GiveItem ( role , 0 , 1541 , 1 , 4 ) --Хит
	elseif (a > 100 and a <= 125) then
...
function ItemUse_FizBust4( role , Item )
	local a = math.random(1, 200)
	if (a > 0 and a < 25) then
		GiveItem ( role , 0 , 1527 , 1 , 4 ) --Берс
	elseif (a >= 25 and a <= 50) then
		GiveItem ( role , 0 , 1532 , 1 , 4 ) --Ускор бега
	elseif (a > 50 and a <= 75) then
		GiveItem ( role , 0 , 1537 , 1 , 4 ) --Додж
	elseif (a > 75 and a <= 100) then
		GiveItem ( role , 0 , 1542 , 1 , 4 ) --Хит
	elseif (a > 100 and a <= 125) then
...
function ItemUse_FizBust5( role , Item )
	local a = math.random(1, 200)
	if (a > 0 and a < 25) then
		GiveItem ( role , 0 , 1528 , 1 , 4 ) --Берс
	elseif (a >= 25 and a <= 50) then
		GiveItem ( role , 0 , 1533 , 1 , 4 ) --Ускор бега
	elseif (a > 50 and a <= 75) then
		GiveItem ( role , 0 , 1538 , 1 , 4 ) --Додж
	elseif (a > 75 and a <= 100) then
		GiveItem ( role , 0 , 1543 , 1 , 4 ) --Хит
	elseif (a > 100 and a <= 125) then
...
function Item_Use_Pendowo(role,Item)
    ...
    if Item_ID == 7477 then --Свиток Атаки
            ...
            local Limit    = 1500    --Limit value you want (Max 32767)
...
function ItemUse_newbie(role, Item)
	local Lv = GetChaAttr(role, ATTR_LV) 
	if Lv >= 30 then
		PopupNotice(role, "Только для персонажей ниже 30 уровня. ")
		UseItemFailed ( role )
	end
