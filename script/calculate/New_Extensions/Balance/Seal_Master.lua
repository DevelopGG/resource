--print("-- Seal Master")
---------------------------------------------
-- Баланс характеристик профессии Колдунья --
---------------------------------------------
	--Макс. кол-во ХП от кона, кона, уровня.
	Mxhp_con_rad1[JOB_TYPE_FENGYINSHI], Mxhp_con_rad2[JOB_TYPE_FENGYINSHI], Mxhp_lv_rad[JOB_TYPE_FENGYINSHI]	= 11, 11, 100				
	...
	Def_con_rad1[JOB_TYPE_FENGYINSHI], Def_con_rad2[JOB_TYPE_FENGYINSHI]	= 0.12, 0.12						
	Hit_dex_rad1[JOB_TYPE_FENGYINSHI], Hit_dex_rad2[JOB_TYPE_FENGYINSHI]	= 0.6, 0 						
	Flee_agi_rad1[JOB_TYPE_FENGYINSHI], Flee_agi_rad2[JOB_TYPE_FENGYINSHI]	= 0.5, 0						
	...
	Srec_bsmxsp_rad[JOB_TYPE_FENGYINSHI], Srec_sta_rad[JOB_TYPE_FENGYINSHI]	= 1/80, 1/10						
	Aspd_agi_rad[JOB_TYPE_FENGYINSHI]	= 0.1 						 				
