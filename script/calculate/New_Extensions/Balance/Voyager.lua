--print("-- Voyager")
-----------------------------------------------------
-- Баланс характеристик профессии Покоритель морей --
-----------------------------------------------------
	--Макс. кол-во ХП от кона, кона, уровня.
	Mxhp_con_rad1[JOB_TYPE_HANGHAISHI], Mxhp_con_rad2[JOB_TYPE_HANGHAISHI], Mxhp_lv_rad[JOB_TYPE_HANGHAISHI]	= 11, 11, 100			
	...
	Def_con_rad1[JOB_TYPE_HANGHAISHI], Def_con_rad2[JOB_TYPE_HANGHAISHI]	= 0.112, 0.112 						
	Hit_dex_rad1[JOB_TYPE_HANGHAISHI], Hit_dex_rad2[JOB_TYPE_HANGHAISHI]	= 0.6, 0 						
	Flee_agi_rad1[JOB_TYPE_HANGHAISHI], Flee_agi_rad2[JOB_TYPE_HANGHAISHI]	= 0.5, 0						
	...
	Aspd_agi_rad[JOB_TYPE_HANGHAISHI]	= 0.1   						 			
