...
function JumpPage( character, npc, page, param )
	...
	if page[param][1] ~= nil and page[param][1].talk ~= nil then
		if page[param][1].talkfunc~= nil then
			if page[param][1].talkfunc == "JJC3TakeItem" then
				JJC3TakeItem(character)
				return
			elseif page[param][1].talkfunc == "JJC1TakeItem" then 
				JJC1TakeItem(character)
				return
			--选择对话
			-- Talk(1,"前置对话","choose","函数标记",参数1,参数2,...,"chooseEnd","对话1","对话2",...)
			elseif page[param][1].talkfunc == "choose" then
			...
			elseif page[param][1].talkfunc == "add" then
				...
				elseif page[param][1].func1 == "CheckTeam" then
					talkadd = CheckTeam(character)
				elseif page[param][1].func1 == "CanChargeJJCXianglian" then
					talkadd = CanChargeJJCXianglian(character)
				elseif page[param][1].func1 == "CheckCanGetJJCZB" then
					talkadd = CheckCanGetJJCZB(character)
				elseif page[param][1].func1 == "GetJJCXLNeedPoint" then
					talkadd = GetJJCXLNeedPoint(character)
				elseif page[param][1].func1 == "NoticeSportsCount" then
					talkadd = NoticeSportsCount(character)
				elseif page[param][1].func1 == "GetJJCXLReturnPoint" then
					talkadd = GetJJCXLReturnPoint(character)
				elseif page[param][1].func1 == "CanReturnJJCXianglian" then
					talkadd = CanReturnJJCXianglian(character)
				...
				if page[param][1].func1~= nil then 
					...
					if roleQues[roleName].quesNext<= page[param][1].p[1] then 
						if QuesLab[curQues].type_ask == 1 then
							CurNextQues = math.mod(roleQues[roleName].quesNext-1,QuesLab[curQues].count)+1
						else
